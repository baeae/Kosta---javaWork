...
public interface BoardService {
	 ...
	 * @param : Board
	 * 
	 * @return : int( 0 이면 등록실패, 1이면 성공)
	 */
	int insert(Board board); // Qa or Free or Upload 허용 //public abstract 붙어있음(생략으로)
	 ...
	 * @param : Board
	 * @return : boolean(true이면 수정완료, false 이면 수정 실패)
	 */
	 ...
	 * 글번호에 해당하는 게시물 검색
	 * @param : int - 글번호
	 * @return : Board - 글번호에 해당하는 게시물이 있으면 Boad  리턴하고 없으면 리턴
	 */
	Board selsecByNo(int no);
