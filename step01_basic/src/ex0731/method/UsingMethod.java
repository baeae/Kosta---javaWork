...
class UsingMethodExam{
	...
	*/	
	...
	protected double methodExam03_04(int a, double b, int C) {
		...
		MakeMethodExam02 t = new MakeMethodExam02();
		
		double i = t.methodExam02_04(a, b, C);
...
class UsingMethod{
	...
	UsingMethodExam t = new UsingMethodExam();
	
	// t.methodExam03_01(3); // 접근제어자 제한으로 인한 오류
	String result = t.methodExam03_02("자바", 5);
	System.out.println("결과 : " + result);

	System.out.println("---------------------------------------");
	
	t.methodExam03_03(3, "메소드");
	System.out.println("---------------------------------------");
	
	t.methodExam03_04(2, 0.5, 3);
	System.out.println("---------------------------------------");
